...
int main(int argc, char *argv[]) {
	...
	Spin_System_Doublet_Nuc_1 spin_time;
	Spin_System_Doublet_Nuc_1 spin_pulse;
	std::vector<double> t;
	auto temp = boost::make_tuple(boost::ref(spin_time), boost::ref(spin_pulse), boost::ref(t_step), boost::ref(B), boost::ref(t));
	temp = load_parameters_Doublet_Nuc_1(argv[1]);
	...
	Spin_System_Doublet_Nuc_1::operator_type rho_eq = spin_time.get_rho_equ();
	Spin_System_Doublet_Nuc_1::operator_type rho;
