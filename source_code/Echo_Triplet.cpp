...
int main(int argc, char *argv[]) {
	...
	for (int i = 0; i < phi.size(); ++i) {
		...
		Spin_System_Triplet::operator_type rho_start = spin_time.get_rho(angles[0], angles[1], angles[2]);
		Spin_System_Triplet::operator_type rho;
